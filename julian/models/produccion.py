...
class Produccion(models.Model):
    ...
    def _cal_price(self, consumed_moves):
        ...
        if finished_move:
            ...
            for work_order in self.workorder_ids:
                ...
                work_center_cost += (((duration / 60.0) * work_order.workcenter_id.costs_hour) + ((duration / 60.0) * work_order.workcenter_id.costo_1)
                + ((duration / 60.0) * work_order.workcenter_id.costo_2))
    ...
    def _prepare_wc_analytic_line(self, wc_line):
        ...
        value = ((hours * wc.costs_hour) + (hours * work_order.workcenter_id.costo_1) + (hours * work_order.workcenter_id.costo_2)) 
